...
void AfeAudioProcessor::Initialize(AudioCodec* codec, int frame_duration_ms, srmodel_list_t* models_list) {
    ...
    afe_config->aec_nlp_level = AEC_NLP_LEVEL_AGGR;  // esp-sr default NLP, balanced for music (VERYAGGR caused distortion)
    afe_config->aec_filter_length = 4;  // 128ms echo tail (reduced from 256ms for music quality)
