...
/**
 * 板C M2 水车+鸟跳 (通过 DRV8833 单向独立控制，原BirdJump类已废弃)�?
 */
...
private:
    ...
    Motor* m3_;          // 水车电机
    Motor* m4_;          // 大门电机(�?
    Motor* bird_door_;   // ⚠️ 注意：变量名是历史遗留，实际驱动的是【小提琴电机】(板B M2, GPIO18/45)
                         // 鸟门已改为 m4_ (板C M1, GPIO9/46)
    Servo* violin_servo_;
    Servo* dog_servo_;
...
public:
    ...
    void BirdJumpPulse();   // 小鸟脉冲跳（说话时用，300ms吸住）
